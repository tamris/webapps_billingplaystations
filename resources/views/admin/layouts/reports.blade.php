...
<head>
    ...
    <title>InvenBar - @yield('title')</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">InvenBar</sup></div>
            </a>
    ...
    <!-- PENTING: Plugin JavaScript untuk DataTables -->
    ...
    @endif
        ...
        {{-- Wadah untuk script dari halaman lain (seperti index.blade.php) --}}
    @stack('scripts')
