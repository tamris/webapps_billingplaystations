...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      <div class="hero-bg">
        <img src="{{ asset('assets2/img/hero-bg-light.webp') }}" alt="">
      </div>
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <img src="{{ asset('assets2/img/hero-services-img.webp') }}" class="img-fluid hero-img" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4">
              <div class="col-lg-6">
                <img src="{{ asset('assets2/img/about-company-1.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="col-lg-6">
                <div class="row gy-4">
                  <div class="col-lg-12">
                    <img src="{{ asset('assets2/img/about-company-2.jpg') }}" class="img-fluid" alt="">
                  </div>
                  <div class="col-lg-12">
                    <img src="{{ asset('assets2/img/about-company-3.jpg') }}" class="img-fluid" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="tab-pane fade active show" id="features-tab-1">
                <img src="{{ asset('assets2/img/tabs-1.jpg') }}" alt="" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-2">
                <img src="{{ asset('assets2/img/tabs-2.jpg') }}" alt="" class="img-fluid">
              </div><!-- End Tab Content Item -->

              <div class="tab-pane fade" id="features-tab-3">
                <img src="{{ asset('assets2/img/tabs-3.jpg') }}" alt="" class="img-fluid">
              </div><!-- End Tab Content Item -->
            </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="{{ asset('assets2/img/features-1.jpg') }}" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('assets2/img/features-2.jpg') }}" class="img-fluid" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="features-image col-lg-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('assets2/img/features-3.jpg') }}" alt="">
          </div>
